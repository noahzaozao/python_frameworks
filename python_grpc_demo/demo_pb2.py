...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\ndemo.proto\x12\x04\x64\x65mo\"\x1b\n\x0bRequestData\x12\x0c\n\x04\x64\x61ta\x18\x01 \x01(\t\"B\n\x0cResponseData\x12\x13\n\x0breturn_code\x18\x01 \x01(\x03\x12\x0f\n\x07message\x18\x02 \x01(\t\x12\x0c\n\x04\x64\x61ta\x18\x03 \x01(\t2\xe3\x01\n\x0b\x44\x65moService\x12\x34\n\tApiCreate\x12\x11.demo.RequestData\x1a\x12.demo.ResponseData\"\x00\x12\x34\n\tApiUpdate\x12\x11.demo.RequestData\x1a\x12.demo.ResponseData\"\x00\x12\x32\n\x07\x41piList\x12\x11.demo.RequestData\x1a\x12.demo.ResponseData\"\x00\x12\x34\n\tApiDelete\x12\x11.demo.RequestData\x1a\x12.demo.ResponseData\"\x00\x62\x06proto3')
)
...
_DEMOSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='ApiCreate',
    full_name='demo.DemoService.ApiCreate',
    index=0,
  ...
  _descriptor.MethodDescriptor(
    name='ApiUpdate',
    full_name='demo.DemoService.ApiUpdate',
    index=1,
    containing_service=None,
    input_type=_REQUESTDATA,
    output_type=_RESPONSEDATA,
  ...
  _descriptor.MethodDescriptor(
    name='ApiList',
    full_name='demo.DemoService.ApiList',
    index=2,
    containing_service=None,
    input_type=_REQUESTDATA,
    output_type=_RESPONSEDATA,
  ...
  _descriptor.MethodDescriptor(
    name='ApiDelete',
    full_name='demo.DemoService.ApiDelete',
    index=3,
    containing_service=None,
    input_type=_REQUESTDATA,
    output_type=_RESPONSEDATA,
